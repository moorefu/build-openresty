...
# 本脚本把 manylinux2014（CentOS 7.9）容器内的 yum 源切换到阿里云镜像：
#   base/updates/extras -> mirrors.aliyun.com/centos-vault/7.9.2009
#   epel               -> mirrors.aliyun.com/epel-archive/7
# 在容器内、执行 build-openresty.sh 之前运行。
set -e
